...
export const phy114SnellsLawLab: Lab = {
  ...
  sections: [
    ...
    },
    {
      kind: 'instructions',
      html: [
        "## Background: Refraction and Snell's Law",
        ...
        "$$\\theta_1 = \\theta_1' \\tag{2}$$",
        "**Snell's Law.** The refracted angle $\\theta_2$ is related to the incident angle $\\theta_1$ by:",
    ...
    },
    {
      ...
      html: [
        ...
        'When light travels from an optically denser medium (higher $n$) into a less dense one ($n_1 > n_2$), there is a maximum angle of incidence called the **critical angle** $\\theta_c$. At this angle, the refracted beam grazes along the boundary ($\\theta_2 = 90$ degrees). For any angle of incidence at or above $\\theta_c$, no light is transmitted and all light is reflected. This is **total internal reflection**. Setting $\\theta_2 = 90$ degrees in Eq. (3):',
        '$$\\theta_c = \\sin^{-1}\\left(\\frac{n_2}{n_1}\\right) \\tag{4}$$',
      ].join('\n\n'),
    },
    {
      kind: 'instructions',
