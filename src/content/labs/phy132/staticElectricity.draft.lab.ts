...
// Source: physics-labs.up.railway.app/labs/staticElectricity
//
...
export const phy132StaticElectricityLab: Lab = {
...
Insert the raw data below: [See Set of Parameters for Q<sub>1</sub> value].`,
    ...
    {
      kind: 'instructions',
      html: 'Record the slope, A, and its uncertainty, ΔA (σₐ).',
    },
    {
      kind: 'multiMeasurement',
      rows: [
...
/** @deprecated Prefer `phy132StaticElectricityLab`; kept for incremental test refactors. */
export const staticElectricityLab = phy132StaticElectricityLab;
