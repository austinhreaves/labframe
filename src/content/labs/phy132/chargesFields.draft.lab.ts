...
// Source: physics-labs.up.railway.app/labs/chargesFields
//
...
export const phy132ChargesFieldsLab: Lab = {
  id: 'chargesFields',
...
How does the electric potential vary with distance from the source? Is the graph of V vs. r linear? How do you know?`,
    ...
    },
    {
      ...
      rows: [
        ...
        { id: 'slopeUncertainty', label: 'Uncertainty of the slope: σₘ =' },
      ],
    },
    {
      kind: 'concept',
...
/** @deprecated Prefer `phy132ChargesFieldsLab`; kept for incremental test refactors. */
export const chargesFieldsLab = phy132ChargesFieldsLab;
