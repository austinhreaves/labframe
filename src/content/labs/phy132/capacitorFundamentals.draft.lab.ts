...
Record the three input values you used below. These will be your reference (initial) values for Parts 1B and 1C.`,
    ...
    },
    {
      ...
      columns: [
        ...
        { id: 'capacitance', label: 'Capacitance C', kind: 'input', unit: 'Symbol(unevaluable)' },
        { id: 'charge', label: 'Top plate charge Q', kind: 'input', unit: 'Symbol(unevaluable)' },
        { id: 'energy', label: 'Stored energy U', kind: 'input', unit: 'Symbol(unevaluable)' },
      ],
      points: 1.5,
    },
    {
